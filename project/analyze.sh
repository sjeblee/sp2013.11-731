...
cat data/egylev/egylevtrain.egylev.one | flookup -x egy.bin > temp.egylevtrain
cat data/egylev/egylevdev.egylev.one | flookup -x egy.bin > temp.egylevdev
cat data/egylev/egylevtest.egylev.one | flookup -x egy.bin > temp.egylevtest
...
java PostProcess data/egylev/egylevtrain.egylev.one temp.egylevtrain data/egylev/egylevtrain.egylev.mish
java PostProcess data/egylev/egylevdev.egylev.one temp.egylevdev data/egylev/egylevdev.egylev.mish
java PostProcess data/egylev/egylevtest.egylev.one temp.egylevtest data/egylev/egylevtest.egylev.mish
